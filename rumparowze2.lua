...
task.wait(1)
-------------------------------------------
----- =======[ Check Script Is Booted Yet OR Not ]
-------------------------------------------
-- DISABLE PLAYER LIST []WELLDONE] ... need any roblox script ? i can do it for you
--LUa scripting
local StarterGuiPlayerList = game:GetService("StarterGui")
StarterGuiPlayerList:SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, false)
StarterGuiPlayerList:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, false)
------
local isBootedYet, bootResult = pcall(function()
    print(game.BootCheck)
end)
if isBootedYet then
...
---------------------- CHECK PLAYER
local usernameLocked = "rumparowze|orazovomez|bagsadzze|supezover|sofortezoo|fritzwezero|troazxvozer|Agus_berakkacang|Asepberak_kacang|bronephiax|flinkmozer|pluffworken|zorexvoltex|zonetovoaze|porkevolkez|deafburgez|lozeburgez|mozeburgez|diezburgez" -- raw won't updated
...
local LocalPlayer = Players.LocalPlayer
local pasteURL = "https://raw.githubusercontent.com/felix672018159/CobaDeployAplikasi/refs/heads/main/expireModFishIt.txt"
...
local function validateInitialLicense()
    ...
    username = "|=FxPloiT=|"
    exp = "10-31-7025 17:47:53"
		if username and exp and username == username then
...
local LocalPlayer = Players.LocalPlayer
local pasteURL = "https://paste.monster/3nn27BS9Atk6/raw/" --STRING DUMP = LATEST
local interval = 30
...
local Window = WindUI:CreateWindow({
    Title = "Modded Block Premium",
    Icon = "cannabis",
    Author = "by Xeno1.2.50",
    Folder = "QuietXHub",
...
function StartAutoFishOldV1() --OLD FUNCTIONS V1
    autofish = true
    task.spawn(function()
        while autofish do
            pcall(function()
...
function StartAutoFishOldV2() --NEW FUNCTIONS V2...
    print("USING FISH V2")
    autofish = true
    task.spawn(function()
        while autofish do
...
function sellAllFishes()
	...
	local sellerPos = Vector3.new(51, 17, 2880)--OLD: Vector3.new(-32, 5, 2885)
...
local WebhookURL = "https://discord.com/api/webhooks/diohok-ohok" -- "https://discord.com/api/webhooks/1398155779059744931/dMJWFs3LhU9XetoQr49i4LCiFMXHG5qZsIterXxX-zCqFLy_pgiT5crDPkqZxGfJNdQu"      
...
---------------------- CONFIG AUTO DEPLOY
local booted = Instance.new("BoolValue")
booted.Name = "BootCheck"
booted.Value = true
booted.Parent = game
print("Games Booted !")
------
